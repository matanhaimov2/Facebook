...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `register_user_trigger` AFTER INSERT ON `register` FOR EACH ROW BEGIN
   INSERT INTO `profiles` (register_id, firstname, lastname, email, birthday)
   VALUES (NEW.id, NEW.firstname, NEW.lastname, NEW.email, NEW.birthday);
END */;;
DELIMITER ;
...
-- Dump completed on 2023-08-26 21:06:26
